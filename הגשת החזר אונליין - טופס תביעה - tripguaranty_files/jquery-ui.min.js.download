...
(function (e, t) {
    function i() {
		...
		this.regional[""] = {
		    closeText: "Done",
		    prevText: "Prev",
		    prevYearText: "PrevYear",
		    nextText: "Next",
            nextYearText: "NextYear",
		    currentText: "Today",
    ...
    e.extend(i.prototype, {
        ...
        _attachHandlers: function (t) {
            ...
            t.dpDiv.find("[data-handler]").map(function () {
                var t = {
                    ...
                    prevYear: function () {
                        e.datepicker._adjustDate(a, -i, "Y")
                    },
                    next: function () {
                        e.datepicker._adjustDate(a, +i, "M")
                    },
        ...
        _generateHTML: function (e) {
            ...
            for (e.drawMonth = Z,
				...
				a = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-datepicker-prev-month ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-datepicker-prev-month ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>",
				i1 = this._get(e, "prevYearText"),
				i1 = z ? this.formatDate(i1, this._daylightSavingAdjust(new Date(et, Z - J1, 1)), this._getFormatConfig(e)) : i1,
				a1 = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-datepicker-prev-year ui-corner-all' data-handler='prevYear' data-event='click' title='" + i1 + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i1 + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-datepicker-prev-year ui-corner-all ui-state-disabled' title='" + i1 + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i1 + "</span></a>",
                a = a + a1,
				s = this._get(e, "nextText"),
				s = z ? this.formatDate(s, this._daylightSavingAdjust(new Date(et, Z + J, 1)), this._getFormatConfig(e)) : s,
				n = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-datepicker-next-month ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-datepicker-next-month ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>",
                s1 = this._get(e, "nextYearText"),
                s1 = z ? this.formatDate(s1, this._daylightSavingAdjust(new Date(et, Z + J1, 1)), this._getFormatConfig(e)) : s1,
                n1 = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-datepicker-next-year ui-corner-all' data-handler='nextYear' data-event='click' title='" + s1 + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s1 + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-datepicker-next-year ui-corner-all ui-state-disabled' title='" + s1 + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s1 + "</span></a>",
                n = n + n1,
				r = this._get(e, "currentText"),
				o = this._get(e, "gotoCurrent") && e.currentDay ? V : W, r = z ? this.formatDate(r, o, this._getFormatConfig(e)) : r,
				...
				g = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"),
