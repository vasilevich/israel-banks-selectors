...
},{"il-bank-account-validator":2,"israeli-bank-autocomplete":6,"israeli-id-validator":7}],2:[function(require,module,exports){
...
},{"./bank-data.json":3,"./functions":5}],5:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.convertBranchesDataFromIsraelBankCSV = exports.fetchCSVFromIsraelBank = void 0;
var DATABASE_URL = "/israeli_banks.csv";
/**
 * Fetch CSV with branches details from Israel Bank
 */
function fetchCSVFromIsraelBank(dbUrl) {
    if (dbUrl === void 0) { dbUrl = DATABASE_URL; }
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var response, blob, Parser, reader;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                blob = _a.sent();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("papaparse")); })];
                            case 3:
                                Parser = (_a.sent()).default;
                                reader = new FileReader();
                                reader.onloadend = function () {
                                    var textDecoder = new TextDecoder('ISO-8859-8');
                                    var decodedData = textDecoder.decode(new Uint8Array(reader.result));
                                    resolve(Parser.parse(decodedData).data);
                                };
                                reader.onerror = function () { return reject(new Error("Failed to read the blob")); };
...
exports.fetchCSVFromIsraelBank = fetchCSVFromIsraelBank;
/**
 * Convert Israel's Bank CSV to JSON data
 * @param csv The CSV
 */
function convertBranchesDataFromIsraelBankCSV(csv) {
    return __awaiter(this, void 0, void 0, function () {
        var headers, branches, banks;
        return __generator(this, function (_a) {
            headers = [
                "bankCode",
                "bankName",
            ...
            branches = csv
                ...
                .filter(function (branch) { return branch.bankCode; });
            //convert bank code to int
            branches = branches.map(function (branch) { return (__assign(__assign({}, branch), { bankCode: parseInt(branch.bankCode, 10) })); });
            banks = branches
                .reduce(function (a, b) {
                if (a.every(function (bn) { return bn.bankCode !== b.bankCode; }) && b.bankCode) {
                    a.push(b);
                }
                return a;
            }, [])
...
},{"papaparse":8}],6:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./dataSource":4}],7:[function(require,module,exports){
